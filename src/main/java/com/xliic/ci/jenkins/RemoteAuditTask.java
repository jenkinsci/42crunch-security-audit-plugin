...
public class RemoteAuditTask extends MasterToSlaveCallable<Void, AbortException> {
    ...
    RemoteAuditTask(FilePath workspace, TaskListener listener, Secret apiKey, String platformUrl, String logLevel,
            String defaultCollectionName, String rootDirectory, String writeJsonReportTo,
    ...
    public Void call() throws AbortException {
        ...
        auditor.setWriteJsonReportTo(writeJsonReportTo);
    ...
    static class WorkspaceImpl implements WritableWorkspace {
        ...
        public void write(URI uri, WorkspaceContent content)
            ...
            try (OutputStream os = filepath.write()) {
                os.write(content.data.getBytes());
            }
